...
(function () {
  ...
  var PRICES = {
    day1: {
      title: 'День №1 · База', date: '24 октября 2026', days: 1,
      cats: {
        vip: { eb: 209, reg: 279, rows: 'ряды 1–2' },
        premium: { eb: 149, reg: 199, rows: 'ряды 3–5' },
        standard: { eb: 112, reg: 149, rows: 'ряды 6–20' },
      },
    },
    day2: {
      title: 'День №2 · Следующий уровень', date: '25 октября 2026', days: 1,
      cats: {
        vip: { eb: 277, reg: 369, rows: 'ряды 1–2' },
        premium: { eb: 217, reg: 289, rows: 'ряды 3–5' },
        standard: { eb: 164, reg: 219, rows: 'ряды 6–20' },
      },
    },
    both: {
      title: 'Оба дня · пакет', date: '24 + 25 октября', days: 2,
      cats: {

...
const GIVE = [
  ...
  { badge: "Охват", icon: "horn", title: "500 человек твоей аудитории", body: "Самый большой известный русскоязычный форум был ~130 человек. Мы целимся в 500 — и они уже в зале." },
];
...
const PLATFORM = [
  ...
  { badge: "📈 Доля", title: "2000 акций каждому спикеру", body: "Под платформу запускаю AG — и выдаю спикерам долю в её будущем." },
];
...
const FORMAT = [
  { title: "Ближе к TED", body: "Единая канва презентаций — общий подход к тому, с чего начинаем и о чём говорим.",
  ...
  { title: "Прикладно", body: "Поднимаем боли, делимся идеями и решениями. «Бери и делай».",
    art: (<svg viewBox="0 0 120 120" fill="currentColor" stroke="none" aria-hidden="true">
  ...
  { title: "Никаких продаж со сцены", body: "Никаких «у меня на курсе». Кейсы и инсайты — если тема зацепит, человек сам найдёт тебя.", danger: true,
    art: (<svg viewBox="0 0 120 120" fill="currentColor" stroke="none" aria-hidden="true">
    ...
    <div className="kit">
      ...
      <header className="hero gridbg">
        <div className="inner">
          ...
          <h1>Самый большой русскоязычный форум о деньгах в Швейцарии.<br /><span className="hl">И мы зовём тебя на сцену!</span></h1>
          <p className="sub">Зал на 500 человек — твоя аудитория. Мы уже знакомы online, и твоя тема может стать одной из сильнейших.</p>
      ...
      <section id="mission" className="gridbg sp-about">
        <div className="inner">
          ...
          <div className="sp-org__card">
            <div className="sp-org__photo sp-org__photo--real"><img src="site/img/ksenia.jpg" alt="Ксения — организатор форума" /></div>
            <div className="sp-org__body">
              <Eyebrow>Организатор форума</Eyebrow>
              <h3 className="sp-org__name">Ксения</h3>
              <p className="lead">Я не первый год собираю людей и события. Один из последних кейсов — MotoZurich в феврале 2026 года: мероприятие на <strong>22 000 человек</strong>. Frankenplatz собираю с тем же подходом: серьёзно, по делу, до мелочей.</p>
      ...
      <section id="how">
        <div className="inner">
          <div className="sp-deal">
            ...
            <h2>Спикеры не платят нам. Мы не платим спикерам. Мы даём то, что деньгами не купишь</h2>
            ...
            <div className="sp-more">
              ...
              <div className="sp-more__cards sp-more__cards--3">
                ...
                <div className="sp-more__card">
                  ...
                  <h3>Пакет акций — каждому спикеру</h3>
                  <p>Под платформу я запускаю AG. Каждый спикер первого форума получает <strong>пакет на 2000 акций</strong> — долю в том, что мы строим.</p>
                </div>
              </div>
      ...
      <section id="who">
        <div className="inner">
          ...
          <p className="lead">В основном — тех, кто работает на швейцарской земле, но интересны и европейские кейсы. Важен результат и польза залу, а не регалии. Одно жёсткое исключение: <strong>право, бухгалтерия, налоги и страхование — только со швейцарским дипломом и лицензией</strong>. Личной историей может делиться каждый.</p>
          <div className="sp-slots">
            <p className="cta-mid__note"><b>Звучит как твоя история?</b> Расскажи о теме — и займи место в списке спикеров, пока программа формируется.</p>
            <Button variant="gold" href="#apply">Хочу выступить</Button>
          </div>
        </div>
      </section>
      ...
      <section id="confirmed">
        <div className="inner">
          <Eyebrow>Кто уже с нами</Eyebrow>
          <h2>Первые подтверждённые спикеры</h2>
          <p className="lead">Список пополняется. Возможно, скоро здесь будешь и ты.</p>
          <div className="grid gauto">
            <div className="conf-cta">
              <div>
                <h3>Есть о чём рассказать?</h3>
                <p>Поднимаем боли и решения. Если твой опыт полезен залу — предложи доклад.</p>
              </div>
              <div style={{ marginTop: 22 }}>
                <Button variant="gold" size="sm" href="#apply">Предложить тему →</Button>
              </div>
            </div>
            <SpeakerCard name="Имя Фамилия" role="Компания · кантон / страна" topic="короткое цепляющее название о том, чем спикер поделится с залом." link="#" linkLabel="LinkedIn" />
            <SpeakerCard name="Имя Фамилия" role="Компания · кантон / страна" topic="короткое цепляющее название о том, чем спикер поделится с залом." link="#" linkLabel="LinkedIn" />
            <SpeakerCard name="Имя Фамилия" role="Компания · кантон / страна" topic="короткое цепляющее название о том, чем спикер поделится с залом." link="#" linkLabel="YouTube" />
          </div>
          <p className="para" style={{ fontSize: 14, color: "var(--muted-2)" }}>Замени плейсхолдеры на реальных спикеров: фото, имя, компанию, тему и ссылку.</p>
        </div>
      </section>
      ...
      <section id="apply" className="center gridbg">
        <div className="inner">
          <ReliefBand variant="final"
            ...
            <p className="fp-band__body">Короткая анкета: о тебе, теме и удобных тайм-слотах. Форму подключим скоро. Дата: 24–25 октября 2026 · Zürich.</p>
          </ReliefBand>
        </div>
      </section>

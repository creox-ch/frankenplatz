    ...
    card.innerHTML =
      ...
      '<form novalidate>' +
        ...
        '<label class="fp-sf__consent"><input type="checkbox" name="consent">' +
          '<span>Согласен(на) на обработку данных для рассмотрения заявки и связи со мной. Подробнее — в <a href="legal.html#datenschutz">политике конфиденциальности</a>.</span>' +
        '</label>' +
